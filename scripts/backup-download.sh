...
#
#   scp root@<IP_VPS>:/opt/setex/shared/backups/postgres/latest.sql.gz.gpg ./
#
...
echo "   scp root@$(hostname -I | awk '{print $1}'):/opt/setex/shared/backups/postgres/latest.sql.gz.gpg ./"
echo ""
echo "2. Descargar la passphrase (solo la primera vez — guárdala segura):"
echo "   scp root@$(hostname -I | awk '{print $1}'):/opt/setex/prod/secrets/backup_passphrase.txt ./"
echo ""
